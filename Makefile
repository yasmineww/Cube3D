...
SRCF = main.c utils/ft_putstr_fd.c utils/ft_split.c utils/ft_strdup.c utils/ft_strlen.c utils/split_texture.c \
	   ...
	   parsing/parsing_utils_4.c parsing/parsing_utils_5.c parsing/parsing_utils_6.c parsing/map_checking.c parsing/parsing_help.c \
	   ...
	   raycasting/render_walls_helper.c raycasting/texture.c raycasting/texture_helper.c raycasting/raycasting_utils.c raycasting/game_utils.c
